...
(function ($) {
	...
	$(document).ready(function(){
		...
		$('.btn.tag-second').click( function () {
			srcTo($('#contact'))
		});
		console.log($(".btn.english").text())
		if($(".btn.english").text() == "English"){
			$fnav.append("<a class='fn-item' item_index='home'>Accueil</a>")
		}else{
			$fnav.append("<a class='fn-item' item_index='home'>Home</a>")
		}
		...
		$('.post-title').each(function () {
			...
			$('.fn-item-styleless').click(function () {
				var i = $(this).attr('item_index');
				var s = $(".post[item_index='"+i+"']");
